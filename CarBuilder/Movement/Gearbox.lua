...
local Gearbox = class("Gearbox")

function Gearbox:initialize(Transmission, axles, data)
    self.Transmission = Transmission

    self.type = data.type or 'MANUAL'
...
function Gearbox:link(engine)
    self.clutch = Clutch(self.data.clutch, self, engine)
    engine.clutch = self.clutch
    engine.gearbox = self
